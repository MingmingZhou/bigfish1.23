    ...
    <#if custReqAttributeList?exists && custReqAttributeList?has_content>
        <#list custReqAttributeList as custReqAttribute>
          ...
          <#if custReqAttribute.attrName == 'SKU_OR_PART'>
            <#assign partNumber = Static["org.ofbiz.base.util.StringUtil"].replaceString(custReqAttribute.attrValue!"",","," ")/>
            <#assign partNumber = Static["org.ofbiz.base.util.StringUtil"].wrapString(partNumber)/>
          </#if>
